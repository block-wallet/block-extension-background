...
import * as balanceChecker from '@blank/background/utils/balance-checker/balanceChecker';
import NetworkController from '@blank/background/controllers/NetworkController';

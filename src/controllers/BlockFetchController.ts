...
const CHAIN_BLOCK_UPDATES_INTERVAL = 15000;
        ...
        try {
            ...
            if (await this._isOffChainServiceAvailable(chainId)) {
                ...
                this._offChainBlockFetchService.setFetch(
                    interval || OFF_CHAIN_BLOCK_UPDATES_INTERVAL,
                    chainId,
                ...
                this._networkController.getProvider().pollingInterval =
                    interval || CHAIN_BLOCK_UPDATES_INTERVAL;
...
export class OffChainBlockFetchService {
    ...
    public setFetch(
        ...
        this._recurrentFetch = setInterval(async () => {
            try {

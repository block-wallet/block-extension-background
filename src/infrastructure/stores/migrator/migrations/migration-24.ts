    ...
    migrate: async (persistedState: BlankAppState) => {
        ...
        for (const userAddress in updatedUserTokens) {
            if (56 in updatedUserTokens[userAddress]) {
                if (
                    toChecksumAddress('0x179960442Ece8dE9f390011b7f7c9b56C74e4D0a') in
                    updatedUserTokens[userAddress][56]
                ) {
                    delete updatedUserTokens[userAddress][56][
                        toChecksumAddress('0x179960442Ece8dE9f390011b7f7c9b56C74e4D0a')
                    ];
                }
            }
        }

...
export const INITIAL_NETWORKS: Networks = {
    MAINNET: {
        ...
        wsUrls: ['wss://mainnet-node.blockwallet.io/ws'],
    ...
    GOERLI: {
        ...
        wsUrls: ['wss://goerli-node.blockwallet.io/ws'],
    ...
    ROPSTEN: {
        ...
        wsUrls: ['wss://ropsten-node.blockwallet.io/ws'],
    ...
    KOVAN: {
        ...
        wsUrls: ['wss://kovan-node.blockwallet.io/ws'],
    ...
    RINKEBY: {
        ...
        wsUrls: ['wss://rinkeby-node.blockwallet.io/ws'],
